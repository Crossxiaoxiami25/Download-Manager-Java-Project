...
package homework4;
/**
 * You must use this class for randomizing the arrival of 
 * DownloadJobs. 
 * We may choose to make internal changes to this for grading
 * But the interface will remain the same.
 * Make sure to initialize this exactly once,
 * call getPremium() and getRegular() exactly once per timestep.
 * You only need to use the public methods.
 *
 *
 */
